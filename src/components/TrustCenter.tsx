...
const policies: PolicySummary[] = [
  ...
  { id: 'ZT-06', name: 'Least-privilege role matrix', implemented: true, enforcement: 'Backend now checks role-to-privilege access for every request before allowing write actions.', justified: 'Ensures each role can only reach the resources and operations the platform explicitly authorizes.' },
  { id: 'ZT-07', name: 'Continuous session revocation', implemented: true, enforcement: 'The middleware now honors session revocation headers and blocks revoked sessions immediately.', justified: 'Allows a compromised or expired session to be stopped promptly without relying on the UI alone.' }
];
      ...
      <section className="bg-neutral-900 text-white rounded-xl p-6 border border-neutral-800 shadow-lg">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-5">
          ...
          <div className="grid grid-cols-3 gap-2 min-w-[280px]">
            <div className="bg-neutral-800 rounded-lg p-3 border border-neutral-700"><div className="text-2xl font-black text-emerald-400">7/7</div><div className="text-[10px] uppercase text-neutral-400 font-bold">Policies live</div></div>
